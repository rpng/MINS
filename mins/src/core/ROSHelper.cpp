...
geometry_msgs::msg::TransformStamped ROSHelper::Pose2TF(const shared_ptr<ov_type::PoseJPL> &pose, bool flip_trans) {
...
geometry_msgs::msg::TransformStamped ROSHelper::Pos2TF(const shared_ptr<ov_type::Vec> &pos, bool flip_trans) {
  assert(pos->size() == 3);
  // Need to flip the transform to the imu frame
...
ov_core::ImuData ROSHelper::Imu2Data(const sensor_msgs::msg::Imu::SharedPtr msg) {
...
std::shared_ptr<pcl::PointCloud<pcl::PointXYZ>> ROSHelper::rosPC2pclPC(const sensor_msgs::msg::PointCloud2::SharedPtr msg, int id) {
...
GPSData ROSHelper::NavSatFix2Data(const sensor_msgs::msg::NavSatFix::SharedPtr msg, int id) {
  GPSData data;
...
GPSData ROSHelper::NavSatFix2Data(const sensor_msgs::msg::NavSatFix::ConstSharedPtr msg, int id) {
  GPSData data;
  data.time = rclcpp::Time(msg->header.stamp).seconds();
  data.id = id;
  data.meas(0) = msg->latitude;
...
bool ROSHelper::Image2Data(const sensor_msgs::msg::Image::ConstSharedPtr msg, int cam_id, ov_core::CameraData &cam, shared_ptr<OptionsCamera> op) {
...
WheelData ROSHelper::JointState2Data(const sensor_msgs::msg::JointState::SharedPtr msg) {
  WheelData data;
  data.time = rclcpp::Time(msg->header.stamp).seconds();
...
WheelData ROSHelper::Odometry2Data(const nav_msgs::msg::Odometry::SharedPtr msg) {
  WheelData data;
  data.time = rclcpp::Time(msg->header.stamp).seconds();
...
ViconData ROSHelper::PoseStamped2Data(const geometry_msgs::msg::PoseStamped::SharedPtr msg, int id) {
...
GPSData ROSHelper::PoseStamped2Data(const geometry_msgs::msg::PoseStamped::SharedPtr msg, int id, double noise) {
  Eigen::Vector3d p(msg->pose.position.x, msg->pose.position.y, msg->pose.position.z);
  GPSData gps;
...
bool ROSHelper::Image2Data(const sensor_msgs::msg::CompressedImage::ConstSharedPtr msg, int cam_id, ov_core::CameraData &cam, shared_ptr<OptionsCamera> op) {
...
nav_msgs::msg::Odometry ROSHelper::ToOdometry(Eigen::Matrix<double, 13, 1> state) {
...
geometry_msgs::msg::PoseWithCovarianceStamped ROSHelper::ToPoseCov(Eigen::Matrix<double, 7, 1> state) {
...
geometry_msgs::msg::PoseStamped ROSHelper::ToENU(geometry_msgs::msg::PoseStamped pose, Eigen::Matrix<double, 7, 1> trans_WtoE) {
